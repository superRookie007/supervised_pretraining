...
DATA_NAME = "informative_10"
UNSHUFFLED_LR = 0.01 #constant learning rate for the base model
PRETRAIN_LR = 0.01 #constant learning rate for pretraining
LAST_LR = 0.01 #constant learning rate for the pretrained model
DECAY = 0.0 #no decay is used
EPOCHS = 1 #number of epochs for both the base model and pretrained model
WIDTH = 1024
DEPTH = 5
ACTIVATION = 'relu'
...
TRAIN_PATH = "{}/synthetic/{}/train.csv".format(cwd, DATA_NAME)
TEST_PATH = "{}/synthetic/{}/test.csv".format(cwd, DATA_NAME)
PRE_TRAIN_PATH = "{}/synthetic/{}/pre_train.csv".format(cwd, DATA_NAME)
PRE_VAL_PATH = "{}/synthetic/{}/pre_val.csv".format(cwd, DATA_NAME)

OUTPUT_PATH = "{}/synthetic/{}.txt".format(cwd, DATA_NAME+"_results")
...
###################################################################################
weights_data_folder = "{}/tmp/weights_synthetic/{}".format(cwd, DATA_NAME)
try:
...
#################################################################################################################################3
    ...
    # save learned initial weighs to file
    ...
    with open(OUTPUT_PATH, 'a') as output_file:
        ...
        output_file.write("Pretraining:  val_loss: %f; val_acc: %f\n\n" % (val_loss, val_acc))
